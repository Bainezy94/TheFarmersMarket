...
class MarketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create market" do
    assert_difference('Market.count') do
      post markets_url, params: { market: { bio: @market.bio, location: @market.location, name: @market.name, opening_hours: @market.opening_hours } }
    end
  ...
  test "should update market" do
    patch market_url(@market), params: { market: { bio: @market.bio, location: @market.location, name: @market.name, opening_hours: @market.opening_hours } }
